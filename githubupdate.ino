...
#define VERSION_FILE_LOCATION "/MilovdZee/RemoteTimer/main/firmware/version.txt"
#define FIRMWARE_FILE_LOCATION "/MilovdZee/RemoteTimer/main/firmware/RemoteTimer.ino-%d.bin"
